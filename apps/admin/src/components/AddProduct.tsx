                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <div className='gap-4 grid grid-cols-3 my-2'>
                          {sizes.map((size) => (
                        ...
                        <div className='space-y-4'>
                          ...
                          {field.value && field.value.length > 0 && (
                            <div className='space-y-4 mt-8'>
                              <p className='font-medium text-sm'>Upload images for selected colors:</p>
                              {field.value.map((color) => (
                                <div className='flex items-center gap-2' key={color}>
                                  <div
                                    ...
                                    style={{ backgroundColor: color }}
                                  />
                                  <span className='min-w-[60px] text-sm'>{color}</span>
